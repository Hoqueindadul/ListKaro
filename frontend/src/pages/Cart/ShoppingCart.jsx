  ...
  return (
    <div className="max-w-[1440px] mx-auto px-4 py-8  dark:bg-[#070d19] text-gray-900 dark:text-white transition-colors duration-200 min-h-screen">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 border-b border-gray-100 dark:border-gray-800 pb-5">
        ...
        {/* Back to Products Button with Glowing Yellow/Blue Gradient Shadow */}
        <Link
          to="/products"
      ...
      {loading ? (
        <div className="flex flex-col items-center justify-center py-32 gap-3">
          <Loader2 className="w-8 h-8 border-cyan-500 text-cyan-500 dark:text-cyan-400 animate-spin" />
        ...
        /* Master Clean Desktop Layout Grid Split */
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center justify-between sm:justify-end gap-6 w-full sm:w-auto border-t sm:border-0 pt-3 sm:pt-0 border-gray-200 dark:border-gray-800">
                    ...
                    {/* Pure Danger Button Action */}
                    <button
                      className="p-2.5 rounded-xl cursor-pointer shadow-lg shadow-emerald-500/20 bg-gray-600 hover:bg-red-500 dark:bg-gray-900/40 dark:hover:bg-red-950/30 text-gray-400 hover:text-red-500 dark:text-gray-500 dark:hover:text-red-400 transition-colors duration-200 shadow-lg"
          ...
          {/* RIGHT COLUMN: Premium Summary Ticket */}
          <div className="dark:bg-[#0b1426] border border-gray-200/60 dark:border-gray-800/60 rounded-3xl p-6 shadow-sm lg:sticky lg:top-6">
            ...
            {/* Checkout Execution Action Wrapper */}
            <button
