              ...
              <div>
                ...
                {showSubTabs && (
                  <div className="pl-6 mt-2 space-y-2">
                    <Link to="/dairy-products" className="block text-sm text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded">Dairy Products</Link>
                    <Link to="/Fruits" className="block text-sm text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded">Fruits</Link>
                    <Link to="/vegetables" className="block text-sm text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded">Vegetables</Link>
                    <Link to="/canned-products" className="block text-sm text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 rounded">Canned Products</Link>
                  </div>
                )}
              </div>
