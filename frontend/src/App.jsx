...
const EmailVerificationPage = React.lazy(() => import("./pages/EmailPassword/EmailVerificationPage"));
const LoginPage = React.lazy(() => import("./pages/Auth/LoginPage"));
const Signup = React.lazy(() => import("./pages/Auth/Signup"));
const ForgotPasswordPage = React.lazy(() => import("./pages/EmailPassword/ForgotPasswordPage"));
const ResetPasswordPage = React.lazy(() => import("./pages/EmailPassword/ResetPasswordPage"));
...
const LoadingFallback = () => (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900">
        <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 animate-pulse">Loading ListKaro...</p>
        </div>
    </div>
);
